...
export default function CheckRegoScreenMotorBike({
  navigation,
  ...
  const [bodyLabel, setBodyLabel] = useState("Classic & vintage  ");
...
<View></View>
    ...
    {regoChecked ? (
     findVehicle? (
<TouchableOpacity style={{marginTop:15}} onPress={()=>{if(!findStolen){setPage0(false);setPage2(true);setIsVisible(true)}}}>
...
<Grid style={{marginTop:0,height:50,borderColor:"white",borderWidth:0.5,borderRadius:10,width:"100%",flex:1}}>
 ...
 <FontAwesome style={{marginTop:15}} name="car" size={20} color="white" />
  ...
  <View style={{height:0.25,backgroundColor:"#d4d3d9",width:"100%",marginTop:40}}></View>  
    ...
    <Row style={{height:90}}>   
    {findStolen?
    <Text style={[MaStyles.titleInput,{marginTop:30,color:"#e63131",textAlign:"center",width:"100%"}]}><AntDesign name="warning" size={15} color="#e63131" /> The above vehicle is REPORTED stolen {"\n"} as of {new Date().toLocaleDateString()}</Text>
    :
    <Text style={[MaStyles.titleInput,{marginTop:30,color:"#5fb313",textAlign:"center",width:"100%"}]}><AntDesign name="checkcircle" size={15} color="#5fb313" /> The above vehicle is NOT reported stolen {"\n"} as of  {new Date().toLocaleDateString()}</Text>
    }
    </Row>    
 </Grid>
...
<Grid style={{marginTop:0,height:50,borderColor:"white",borderWidth:0.5,borderRadius:10,width:"100%",flex:1}}>
  ...
  <Text style={[MaStyles.titleInput,{marginTop:5,color:"gray"}]}>Rego is not on NZTA Database</Text>
  </Col>
  </Row>
  <Row>
  <View style={{height:0.25,backgroundColor:"#d4d3d9",width:"100%",marginTop:40}}></View>  
...
<Grid>
        <Row style={{paddingHorizontal: 20, height: 40, marginTop: 0}}>
          <Grid>
            ...
            <Col style={{marginTop:-3}} onPress={() => navigation.goBack()} size={10}>
        ...
        <View style={{width: "100%", flex: 1}}>
          ...
          <View style={{flex: 2, width: "100%"}}>
            <View style={{bottom: 0, paddingBottom: 0}}>
              ...
              <TouchableOpacity style={{marginTop: 0}} onPress={() => go2()}>
      ...
      {page2 && (
        ...
        >
         <ProgressBar stepActive={0} titleText={"Vehicle Details"} /> 
              ...
              <View style={{marginTop:30,height:120,borderColor:"#0e4e92",borderWidth:0.5,borderRadius:10,width:"100%",flex:1,borderStyle:"dashed"}}>
                <Row style={{paddingHorizontal:20}}>
                  <Col size={5} style={{justifyContent:"center"}}>
                  <Text style={[MaStyles.titleInputBox,{marginTop:0}]}>{findYear} {findMake} {findModel}</Text>
                    <Text style={[MaStyles.titleInput,{marginTop:15,color:"gray"}]}>Plate: {rego}</Text>
                  </Col>
                  <Col style={{justifyContent:"center"}}>
                  <Image  style={{width:40,height:40,alignSelf:"center"}} source={require("../../assets/images/checked.png")}></Image>
                  </Col>
                </Row>
              </View>

          <Grid style={{paddingBottom:200}}>
          
         
          <Row style={{marginTop: 0, height: 70}}>
              <Text style={[MaStyles.titleInput]}><FontAwesome name="info-circle" size={14} color="#c29f1b" /> Information such as engine, body type, fuel, etc will be displayed automatically</Text>
            </Row>
 ...
 */}
    ...
    {/*         <Row style={{marginTop: 0, height: 45}}>
          ...
          <Text style={[MaStyles.titleInput]}>Body Type</Text>
            ...
            <Row style={{marginTop: 0, height: 43}}>
              <Text style={[MaStyles.titleInput]}>Transmission <Text style={{fontSize:10,color:"gray"}}>(Optional)</Text></Text>
            </Row>
            <Row style={{marginTop: 15, height: 40}}>
              <Col>
                <Text style={transmisionL()} onPress={(value) => openModal5()}>
                  {transL}
                </Text>
              </Col>
            </Row>
            ...
            <Row style={{marginTop: 0, height: 45}}>
              <Text style={[MaStyles.titleInput]}>Fuel Type <Text style={{fontSize:10,color:"gray"}}>(Optional)</Text></Text>
            </Row>
            <Row style={{marginTop: 15, height: 40}}>
              <Col>
 ...
 */}
        {/*     <Row style={{marginTop: 0, height: 45}}>
            ...
            <Row style={{marginTop: 0}}>
              <Text style={[MaStyles.titleInput]}>Description <Text style={{fontSize:10,color:"gray"}}>(Optional)</Text></Text>
            </Row>
            ...
            <Row style={{marginTop: 15, height: 200, marginBottom: 100}}>
    ...
    <ProgressBar stepActive={1} titleText={"Images"} /> 
          ...
          <TouchableOpacity  onPress={() => setImageVisible(true)} style={MaStyles.buttonViewUploadFoto}>
            <Text onPress={() => setImageVisible(true)} style={MaStyles.buttonTextUploadImage}>
...
<ModalR
        ...
        style={[
          MaStyles.containerM,
          {
            ...
            backgroundColor: "white",paddingTop:30
          },
        ]}
      >
        <View
          ...
          {paymentPage && (
            ...
            >
              ...
              />
                  ...
                  {/* page6 */}
                  {isDone &&
      <View style={{width:"100%",height:"100%",position:"absolute",marginTop:-40}}>
      <DoneScreen 
...
<ModalR
      ...
      <FooterBar 
        nextTitle={nextTitle} backTitle={backTitle}
        onPressItemNext={()=>handlePressNext()} onPressItemBack={()=>handlePressBack()}
        isBackButton={false} isVisible={isVisible}     />
