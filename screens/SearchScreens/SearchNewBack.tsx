...
export default function SearchResultScreen({
  ...
  const renderImages = (images2, id) => {
    ...
    images2.forEach((element) => {
      let urlI = Globals.S3_THUMB_URL_300 + element.pic_url;
      ...
      <View style={{ marginTop: 10 }}>
        <SharedElement id={"photos"}>
          <SliderBox
            ...
            images={images}
            style={{ width: "80%", height: 135, backgroundColor: "white" }}
  ...
  return (
    <View style={[MaStyles.container, { marginHorizontal: 0 }]}>
          ...
          <Col>
            <Row style={{ marginTop: -20 }}>
              ...
              >
                ...
                >
                  <Text style={MaStyles.buttonTextNear}>Filters</Text>
                </TouchableOpacity>
                    ...
                    >
                      ...
                      >
                        ...
                        <Grid style={{ marginTop: 15 }}>
                          ...
                          <Col style={{ height: 30, marginTop: 3 }}>
                            <Text style={MaStyles.daysAgoSearch}>
                              {findDaysDiffrent(item.indate)}
                            </Text>
                          </Col>
                        </Grid>
                      </View>
      ...
      >
        ...
        <Row
              onPress={() => searchCar()}
              style={{ height: 120, width: "99%",position:"absolute",bottom:0,alignSelf:"center"}}
            >
              <TouchableOpacity
                onPress={() => searchCar()}
                style={MaStyles.buttonViewC}
              >
                <Text style={MaStyles.buttonTextC}>Apply</Text>
              </TouchableOpacity>
            </Row>
      </Modal>
