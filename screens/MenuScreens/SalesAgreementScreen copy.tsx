...
export default function SalesAgreementScreen({
  ...
  const [dateDelivery, setDeliveryDate] = useState(new Date());

  const [dateL, setDateL] = useState(getFormattedDate(new Date()));
  const [dateWofL, setDateWofL] = useState(getFormattedDate(new Date()));
  const [dateLicenseL, setDateLicenseL] = useState(
    getFormattedDate(new Date())
  );
  const [datePayL, setDatePayL] = useState(getFormattedDate(new Date()));
              ...
              <Row style={{ marginTop: 10, height: 40 }}>
                <Col>
                  ...
                  dd-mm-yyyy"
                    ...
                    style={styleFocus("date2")}
                    onFocus={() => setIsFocused("date2")}
                    placeholderTextColor={"#d4d3d9"}
                    type={"datetime"}
                    options={{
                      format: "DD-MM-YYYY",
              ...
              <Row style={{ marginTop: 10, height: 40 }}>
                <Col>
                  ...
                  dd-mm-yyyy"
                    ...
                    style={styleFocus("date3")}
                    onFocus={() => setIsFocused("date3")}
                    placeholderTextColor={"#d4d3d9"}
                    type={"datetime"}
                    options={{
                      format: "DD-MM-YYYY",
              ...
              <Row style={{ marginTop: 10, height: 55 }}>
                ...
                <Col>
                  ...
                  dd-mm-yyyy"
                        ...
                        style={styleFocus("date4")}
                        onFocus={() => setIsFocused("date4")}
                        placeholderTextColor={"#d4d3d9"}
                        type={"datetime"}
                        options={{
                          format: "DD-MM-YYYY",
              ...
              <Row style={{ marginTop: 10, height: 55 }}>
                ...
                <Col style={{ marginTop: 5 }}>
                  ...
                  dd-mm-yyyy"
                    ...
                    style={styleFocus("date5")}
                    onFocus={() => setIsFocused("date5")}
                    placeholderTextColor={"#d4d3d9"}
                    type={"datetime"}
                    options={{
                      format: "DD-MM-YYYY",
